...
$getList=$db->ExecuteQuery("SELECT sent_reg_fees.Sent_Id,sent_reg_fees.Appr_Status,sent_reg_fees.Total_Amount,sent_reg_fees.Payment_Date,sent_reg_fees.CM_Id, cm_login.Center_Code FROM sent_reg_fees LEFT JOIN cm_login on sent_reg_fees.CM_Id=cm_login.CM_Id");
