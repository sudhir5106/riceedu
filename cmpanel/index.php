...
$cmImg=$db->ExecuteQuery("SELECT EMP_Image,EMP_Name,EMP_Designation,EMP_Code,Perfromance,DATE_FORMAT(DOJ,'%d-%M-%Y') AS DOJ,Posting_Place,Block_Name,District_Name,emp_sign,State_Name,Posting_Place,Visiting_Date_Place,Duty_Time,EMP_Address,Visiting_Date_Place,EMP_Contact,EMP_Email 
...
<div>
  <div class="page-title">
    <div class="title_left">
      <h3><i class="fa fa-home"></i>Dashboard</a></li></h3>
    </div>
  </div>
      ...
      <div class="x_panel">
        ...
        <div class="x_content">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                    ...
                    <div class="signature">
                      <img src="<?php echo PATH_DATA_IMAGE.'/employee/signature/thumb/'.$cmImg[1]['emp_sign']; ?>" alt="Avatar">
                   ...
                   <div class="center details">
                    ...
                    <div class="profile_title">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-sm-3">Performance</div>
                            <div class="col-sm-7"><?php echo $cmImg[1]['Perfromance'];?></div>
                        </div>
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs" style="margin-top:50px;">
                        ...
                        <?php 
                          ...
                          <div class="col-sm-3 imgBlck">
                              ...
                              <div class="galleryImg"><img width="100%" src="
                              <?php echo PATH_DATA_IMAGE_CM."/img-gallery/thumb/".$value['CM_Image'];?>" alt="" /></div>
                            <div>
