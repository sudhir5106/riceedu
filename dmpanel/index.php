<?php 
include('../config.php');
require_once(PATH_DM_INCLUDE.'/header.php');
...
(SELECT  DM_Emp_Code FROM dm_login WHERE DM_Id =".$_SESSION['dmid'].")  ");
$cm_code=$db->ExecuteQuery("SELECT * FROM dm_login WHERE DM_Id =".$_SESSION['dmid']);
            ...
            <div class="center details">
              <div class="profile_title">
                ...
                <div class="data-row">
                  ...
                  <div class="col-sm-7"><?php echo $cm_code[1]['DM_Password']; ?></div>
                </div>
              </div>
              <div>
...
<?php 
require_once(PATH_DM_INCLUDE.'/footer.php');
