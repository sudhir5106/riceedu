<?php 
	...
	require_once(PATH_DM_INCLUDE.'/head.php');
	//Check Here If Admin is authorised or not
	if(empty($_SESSION['dmid']))
	{?>
		<script>
...
<script>
	$(document).ready(function() {
		$("#logoff").click(function(){
			...
			$.ajax(
			{
				url:'<?php echo LINK_CONTROL_DM.'/logout.php'; ?>',
				type:'POST',
				data:{},
				async:false,
...
<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;"> <a href="index.php" class="site_title"><i class="fa fa-laptop"></i> <span>DM Panel</span></a> </div>
    ...
    <div class="profile">
      ...
      <div class="profile_info"> <span>Welcome,</span>
        <h2><?php echo $_SESSION['dmname']?></h2>
      </div>
    </div>
    <!-- /menu prile quick info --> 
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          <li><a href="<?php echo LINK_CONTROL_DM?>"><i class="fa fa-home"></i>Dashboard</a></li>
          <!--<li><a><i class="fa fa-file-text-o"></i>Tenders<span class="fa fa-chevron-down"></span></a>
          	<ul class="nav child_menu" style="display: none">
              <li><a href="<?php echo LINK_CONTROL_DM?>/tenders/index.php">Add New</a></li>
              <li><a href="<?php echo LINK_CONTROL_DM?>/tenders/list.php">View List</a></li>
              <li><a href="<?php echo LINK_CONTROL_DM?>/tenders/archives.php">Archive Tenders</a></li>
            </ul>
          </li>-->
  ...
  <div class="nav_menu">
    <nav class="" role="navigation">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class=""> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="<?php echo PATH_IMAGE?>/img.jpg" alt=""><?php echo $_SESSION['dmname']?><span class=" fa fa-angle-down"></span> </a>
