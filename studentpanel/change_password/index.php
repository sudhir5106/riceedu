      ...
      <div class="x_panel">
        <div class="x_content" style="padding-top:30px;">
        	<form  class="form-horizontal"   id="changePassword" method="post" >
                ...
                <input type="hidden" id="adminId" name="adminId" value="<?php echo $s_id;?>"/>
                <input type="hidden" id="password" name="password" value="<?php echo $res[1]['Password'];?>"/>
              ...
              <fieldset>
               <div class="alert alert-success" id="success" role="alert" style="display:none;">...</div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="password" placeholder="New Password" id="new_pwd" name="new_pwd" class="form-control input-sm" >
                  </div>
                </div>
                <div class="form-group">
