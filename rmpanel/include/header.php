<?php 
	...
	require_once(PATH_RM_INCLUDE.'/head.php');
	//Check Here If Admin is authorised or not
	if(empty($_SESSION['rmid']))
	{?>
		<script>
...
<script>
	$(document).ready(function() {
		$("#logoff").click(function(){
			...
			$.ajax(
			{
				url:'<?php echo LINK_CONTROL_RM.'/logout.php'; ?>',
				type:'POST',
				data:{},
				async:false,
...
<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;"> <a href="index.php" class="site_title"><i class="fa fa-laptop"></i> <span>RM Panel</span></a> </div>
    ...
    <div class="profile">
      ...
      <div class="profile_info"> <span>Welcome,</span>
        <h2><?php echo $_SESSION['rmname']?></h2>
      </div>
    </div>
    <!-- /menu prile quick info --> 
  ...
  <div class="nav_menu">
    <nav class="" role="navigation">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class=""> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="<?php echo PATH_IMAGE?>/img.jpg" alt=""><?php echo $_SESSION['rmname']?><span class=" fa fa-angle-down"></span> </a>
